...
<body>
            ...
            <div class="show-mobile">
                <div class="site-menu">
                    <ul class="menu">
                        ...
                        <li><a href="servicios.html">Servicios </a><span class="sb" style="font-size: 18px">+</span>
    ...
    <nav class="navbar">
        <div class="container">
            <!-- Logo Menu Desktop -->
            <div class="logo"> <a href="inicio.html"><img src="img/logo.png" alt="Image"></a> </div>
            <div class="site-menu">
                <div class="container">
                    <div class="row">
                        <div class="col-md-4">
    ...
    <header class="page-header page-header-form-contact " data-wow-delay="0.5s" data-background="img/page-header.jpg">
        <div class="container ">
            <h2>
                <?php
                if (isset($_POST['name']) && isset($_POST['email']) && isset($_POST['telefon']) && isset($_POST['message'])) {
                    ...
                    if (empty($ad) || empty($email) || empty($telefon) || empty($mesaj)) {
                        echo 'Formulario vacío, por favor rellene los campos';
                    } else {
                        $toEmail = 'rafaelpajuelot@gmail.com';
                        $emailSubject = 'Nuevo correo electronico desde tu formulario de contacto';
